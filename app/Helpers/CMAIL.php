...
class CMAIL
{
    public static function send($config)
    {
        ...
        try {
            ...
            $mail->Port = config('services.mail.port');  //TCP port to connect to
            ...
            $recipientName = isset($config['recipient_name']) ? $config['recipient_name'] : null;
            $mail->addAddress($config['recipient_address'], $recipientName);  //Add a recipient
